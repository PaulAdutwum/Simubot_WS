...
#include "custom_msgs/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msgs::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::DetectedObject & ros_message)
{
  // Member: class_id
  cdr >> ros_message.class_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msgs::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, DetectedObject)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
