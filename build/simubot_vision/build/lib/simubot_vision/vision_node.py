...
class VisionNode(Node):
    def __init__(self):
        ...
        # Get simulation time parameter without declaring it
        use_sim = self.get_parameter_or('use_sim_time', rclpy.Parameter('use_sim_time', rclpy.Parameter.Type.BOOL, True)).value
        if use_sim:
